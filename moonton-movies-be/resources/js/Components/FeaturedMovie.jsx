    ...
    return (
        <>
            ...
            <div className="group absolute mr-[30px] overflow-hidden">
                ...
                {/* Bottom Detail */}
                <div className="absolute bottom-0 left-0 right-0 flex h-[130px] items-center justify-between rounded-bl-[28px] rounded-br-[28px] bg-gradient-to-t from-black px-7">
                    <div>
